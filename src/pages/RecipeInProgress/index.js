...
import { Icon, Category, Div, P,
  Title, Instructions, Button, SectionDetails } from '../../styles/style';
import { Ingredient } from './style';
      ...
      { startApi.map((e, i) => (
        <section key={ i }>
          <Div>
            ...
            />
            <Category data-testid="recipe-category">{ e.strCategory }</Category>
                  ...
                  <li key={ index }>
                    ...
                    >
                      <input
                        ...
                        type="checkbox"
                      />
                      <p>{ `${d} ${ingredients.measure[index] || ''}` }</p>
                    </label>
                  </li>))}
              </Ingredient>
